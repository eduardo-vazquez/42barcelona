...
/*   Updated: 2023/10/23 23:15:21 by evazquez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/push_swap.h"

int	ft_sa(node **stacks)
{
	if	(ft_swap(&stacks[0]))
		write(1, "sa\n", 3);
	return (1);
